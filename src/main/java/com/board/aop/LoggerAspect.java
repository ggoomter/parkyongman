...
public class LoggerAspect {
	...
	public Object printLog(ProceedingJoinPoint joinPoint) throws Throwable {
		...
		String type = "";
		String name = joinPoint.getSignature().getDeclaringTypeName();	//파일명을 포함한 전체 패키지경로
		...
		logger.debug(type + name + "." + joinPoint.getSignature().getName() + "()");	//어떤 클래스의 어떤 메소드를 호출하는지 출력
